...
public class __Constants__ {
    ...
    public static final int HANDLER_CHRONOMETER_TIMER = 3;
    public static final int HANDLER_BLUETOOTH_CONNECT = 4;
    public static final int HANDLER_BLUETOOTH_START = 5;
    public static final int HANDLER_BLUETOOTH_STOP = 6;
    public static final int HANDLER_BLUETOOTH_TIMER = 7;
    public static final int HANDLER_BLUETOOTH_RESET = 8;
    public static final int HANDLER_BUFFERS_PATH = 9;
    public static final int HANDLER_BUFFERS_LINK = 10;
    public static final int HANDLER_BUFFERS_FLUSH= 11;
    public static final int HANDLER_BUFFERS_CLEAR = 12;
